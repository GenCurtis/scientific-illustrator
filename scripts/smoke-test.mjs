...
const servers = [
  ...
  },
  {
    ...
    tools: ["powerpoint_status", "powerpoint_officejs_status", "powerpoint_set_backend", "powerpoint_get_capabilities", "powerpoint_add_table", "powerpoint_add_chart", "powerpoint_audit_figure", "powerpoint_save"],
